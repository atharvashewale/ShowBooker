...
}) 
{
  ...
  if(selectedMovies)
    selectedMovies.releaseDate = moment(selectedMovies.releaseDate).format("DD-MM-YYYY");
  ...
  const onFinish = async (values) => {
    try {
      ...
      if (formType === "add") 
        ...
        response = await updateMovie({ ...values, movieId: selectedMovies._id });
...
return (
    ...
    footer={null}
    >
    <Form layout="vertical" initialValues={selectedMovies} onFinish={onFinish}>
